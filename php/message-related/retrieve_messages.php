...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        */
        ...
        if (($sender_name == $display_name && $recipient_name == $contact_name) || ($sender_name == $contact_name && $recipient_name == $display_name)) {
            $get_message = true;
        } else if ($recipient_name == "all" && $contact_name == "all") {
            $get_message = true;
        } else {
            $get_message = false;
        }
